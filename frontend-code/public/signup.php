                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 col-xl-7 mx-auto">
                            ...
                            <form action="../../backend-code/sign_up.php" method="POST" onsubmit="return check()" name='login'>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="password" class="form-control" id="confpass" style="border-radius: 40px" placeholder="Confirm Password" required name="confpassword">
									<p id='inpass'></p>
                                </div>
                                <div class="form-group mb-3">
